			...
			switch (_p14.ctor) {
				...
				case 'SetToday':
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							today: _elm_lang$core$Maybe$Just(_p14._0)
						});
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							days_to_skip: A2(
								...
								_user$project$Main$toComparableDate(_p14._0),
								model.days_to_skip)
						});
				case 'UnskipDay':
					return _elm_lang$core$Native_Utils.update(
						...
						model,
						{
							days_to_skip: A2(
								...
								_elm_lang$core$Set$fromList(
									A2(_elm_lang$core$List$map, _user$project$Main$toComparableDate, _p14._0)))
						});
				default:
					return _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$makeCalendar = function (model) {
	...
	var aggMonth = F2(
		function (info, res) {
			var _p25 = _user$project$Main$uncons(res);
			if (_p25.ctor === 'Nothing') {
				...
				return _elm_lang$core$Native_Utils.eq(
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p26,
						{
							days: {ctor: '::', _0: info, _1: _p26.days}
						}),
					_1: _p25._0._1
				} : {
					ctor: '::',
	...
	var whatIs = function (info) {
		return _user$project$Main$isWeekend(info.date) ? _user$project$Main$Weekend : (A2(
			...
			model.days_to_skip) ? _user$project$Main$NoSchool : ((_elm_lang$core$Native_Utils.cmp(
			info.completed,
			_user$project$Main$alwaysInt(model.days_required)) < 0) ? _user$project$Main$School(info.completed + 1) : _user$project$Main$Weekend));
	};
		...
		function (res, currentYear, info) {
			...
			while (true) {
				if (!_elm_lang$core$Native_Utils.eq(
					...
					var d = makeDay(info);
					var _v21 = {ctor: '::', _0: d, _1: res},
						_v22 = currentYear,
						_v23 = A2(nextDayInfo, info, d);
					res = _v21;
					currentYear = _v22;
					info = _v23;
	...
	if (_p28.ctor === 'Nothing') {
		...
		return splitMonths(
			A2(
				makeDays,
				_elm_lang$core$Date$year(_p29),
				A2(firstDayInfo, _p29, model)));
	}
};
